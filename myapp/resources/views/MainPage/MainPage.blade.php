...
<head>
    ...
    <body align = center>
        ...
        <ul>
            ...
            if (session('user_id') === 'driver') {
                ?>
                <h1>{{session('user_id')}}버스기사 Page</h1>
                <a href = '../user/LogOut.php' id = 'current'>로그아웃</a>&nbsp
            ...
            if (session('user_id') !== null) {
                ...
                <a href = '/LogOut.php' id = 'current'>로그아웃</a>&nbsp
                <a href = '../user/withdrawalForm.php' id = 'current'>회원 탈퇴</a>
                <?php
            } else {
                ?>
                <a href = '/LoginForm' id = 'current'>로그인</a>&nbsp
                <a href = '/RegForm' id = 'current'>회원가입</a>
                <?php
            }
            exit;
            ?>
